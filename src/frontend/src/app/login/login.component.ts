        ...
        <div [ngStyle]="cardStyle">
          ...
          @if (notInvitedBanner()) {
            <div [ngStyle]="bannerStyle('red')">
              Your account is not registered. Contact an administrator to be invited.
            </div>
          }
          ...
          <div style="display:flex;flex-direction:column;gap:14px">
            ...
            <div style="display:flex;flex-direction:column;gap:5px">
              <label [ngStyle]="labelStyle">
                ...
                <span (click)="router.navigate(['/forgot-password'])"
                      [ngStyle]="forgotLinkStyle">Forgot password?</span>
              </label>
            ...
            <div [ngStyle]="dividerStyle">
              ...
              <span [ngStyle]="dividerTextStyle">or continue with</span>
              <span [ngStyle]="dividerLineStyle"></span>
            </div>
    ...
    this.auth.login(this.email(), this.password()).subscribe({
      next: () => {
        this.auth.getMe().subscribe({
          ...
          error: () => {
            this.submitting.set(false);
            this.errorMsg.set('Login succeeded but failed to load user data.');
          }
        });
      },
      error: (err) => {
